...
<div class="panel-heading">
    <h4 style="display: inline;color: inherit;font-size: 12px;line-height: 20px;margin-top: 0;margin-bottom: 0;margin-right: 15px;">{{title2}}</h4>
...
export default {
    props: ['pagePara', 'apiName', 'listTitle'],
    data: function() {
        return {
            title2: ''
        }
