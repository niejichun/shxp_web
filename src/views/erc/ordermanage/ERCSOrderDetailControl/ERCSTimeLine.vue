    ...
    watch: {
        order: function() {
            ...
            function initTimeLine() {
                ...
                if (_self.order.statedict.PAYED)
                    $("#li_payed").addClass("complete");
                if (_self.order.statedict.REVIEWING)
                    $("#li_reviewing").addClass("complete");
                if (_self.order.statedict.SHIPPED)
                    $("#li_shipped").addClass("complete");
