        ...
        initTable: function () {
            ...
            this.masterTable.bootstrapTable({
                ...
                columns: [
                    ...
                    common.BTRowFormatAlignRight('apply_price', '采购价格'),
                    common.BTRowFormatAlignRight('apply_amount', '数量'),
                    common.BTRowFormatAlignRight('remain_number', '已入库数量'),
                    common.BTRowFormatAlignRight('store_price', '入库平均价格')
                ],
                sortOrder:'asc',
...
//            } else {
            if (zoneForm.parsley().isValid()) {
                _self.$router.push({path: 'ERCOtherInMaterielControl', query: {
