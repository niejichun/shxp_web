            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body auto-height hidedesk">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="col-sm-5 control-label">生产任务单号</label>
                                <div class="col-sm-7">
                                    <input class="form-control" v-model="orderData.productivetask_code" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
...
export default {
    ...
    name: 'ERCProductInHistoryDetailControl',
    filters: {
        date_format(value) {
    ...
    methods: {
        ...
        initHistoryTable: function() {
            this.masterTable.bootstrapTable({
                method: 'POST',
                url: apiUrl + 'getProductInOrderHistoryDetail',
                ...
                columns: [
                    ...
                    common.BTRowFormatAlignRight('taskdesign_price', '单价'),
                    common.BTRowFormatAlignRight('account_operate_amount', '入库数量'),
                    common.BTRowFormatWithFormatterAlignRight('total_price', '总价', (value, {taskdesign_price, account_operate_amount}) => (taskdesign_price * account_operate_amount)),
                ],
                sortOrder: 'asc',
                idField: 'bill_code',
                uniqueId: 'bill_code',
