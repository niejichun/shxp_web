        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">生产领料流水单</h4>
                </div>
    ...
    methods: {
        ...
        initHistoryTable: function() {
            this.masterTable.bootstrapTable({
                method: 'POST',
                url: apiUrl + 'getProductOutHistoryDetail',
        ...
        printDetail: async function() {
            let _self = this
            try {
                let response = await _self.$http.post(apiUrl + 'productOutHistoryPrint', {
