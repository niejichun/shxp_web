...
export default {
    ...
    name: 'ERCBuyInHistoryDetailControl',
    filters: {
        date_format(value) {
        ...
        initHistoryTable: function() {
            this.masterTable.bootstrapTable({
                ...
                columns: [
                    ...
                    common.BTRowFormatAlignRight('purchase_price', '单价'),
                    common.BTRowFormatAlignRight('account_operate_amount', '入库数量'),
                    common.BTRowFormatWithFormatterAlignRight('total_price', '总价', (value, {purchase_price, account_operate_amount}) => (purchase_price * account_operate_amount)),
